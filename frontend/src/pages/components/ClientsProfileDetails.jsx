    ...
    <div className=''>
      <div className=' px-2 mx-4 rounded'>
        <div className='w-full px-8 py-4 mx-auto mt-16 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 rounded-lg shadow-md dark:bg-gray-800'>
          ...
          <h2 className='mt-2 gap-2 flex text-2xl font-semibold text-gray-800 dark:text-white md:mt-0 md:text-3xl'>
            {userData.fullname}{" "}
            {userData.nidVerified ? (
              <GoVerified className='text-sky-500 text-xl mt-1' />
            ) : (
              ""
            )}
          </h2>
          ...
          {userData.nidVerified ? (
            ...
            <div className='justify-start mt-2'>
              <p className='text-sm md:text-base font-medium text-gray-900'>
                Your Recruiter Profile is not verified with NID.
              </p>
              <p
                className='text-sm md:text-base font-medium text-gray-900 flex gap-2 hover:underline focus-visible:underline'
                onClick={() => navigate("/profile")}
              >
                <GoVerified className='text-sm md:text-base cursor-pointer mt-1' />
                Verify Now!
              </p>
            </div>
          )}
        ...
        <div className='flex justify-center'>
          ...
          <button className='flex items-center h-12 px-2 py-2 text-center text-gray-700 bg-transparent border-b border-gray-300 sm:px-4 dark:border-gray-500 -px-1 dark:text-white whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400 dark:hover:border-gray-300'>
            ...
            <Link className='no-underline text-gray-700' to='/mypost'>
              <span className='mx-1 text-sm sm:text-base'>My Post</span>
            </Link>
          </button>
          ...
          <div className='text-gray-700'>
            <div className='grid md:grid-cols-2 text-sm'>
              ...
              <div className='grid grid-cols-2'>
                ...
                <div className='px-4 py-2'>{userData.officeAdress}</div>
              </div>
              <div className='grid grid-cols-2'>
              ...
              <div className='grid grid-cols-2'>
                ...
                <div className='px-4 py-2'>{userData.organization}</div>
              </div>
              <div className='grid grid-cols-2'>
              ...
              {/* <div className="grid grid-cols-2">
                ...
                <div className="px-4 py-2">{userData.expertise || "No Data"}</div>
              </div>
              <div className="grid grid-cols-2">
              ...
              <div className="grid grid-cols-2">
                ...
                <div className="px-4 py-2">{userData.experience || "No Data"}</div>
              </div>
              <div className="grid grid-cols-2">
              ...
              <div className='grid grid-cols-2'>
                ...
                <div className='px-4 py-2'>{userData.website || "No Data"}</div>
              </div>
            </div>
          </div>
          <button
