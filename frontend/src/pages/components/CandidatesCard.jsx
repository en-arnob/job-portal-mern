...
const CandidatesCard = ({ candidate, pageNumber }) => {
  ...
  return (
    <div
      className='w-80 mx-auto overflow-hidden bg-gray-700 rounded-lg  dark:bg-gray-800  mb-4'
      onClick={() => {
    ...
    >
      ...
      <div className='flex items-center px-2 py-2 bg-green-300'>
        <h1 className='mx-3 text-sm font-semibold text-white'>Open for Work</h1>
      </div>
      ...
      <div className='px-6 py-4'>
        ...
        <p className='py-2 text-gray-200 dark:text-gray-400'>
